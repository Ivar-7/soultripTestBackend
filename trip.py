...
@trip_bp.route('/api/trips/<int:trip_id>/locations', methods=['POST'])
@login_required
...
@trip_bp.route('/api/trips/<int:trip_id>/locations', methods=['GET'])
@login_required
...
@trip_bp.route('/api/locations/<int:location_id>', methods=['PUT'])
@login_required
...
@trip_bp.route('/api/locations/<int:location_id>', methods=['DELETE'])
@login_required
